...
var _newsService = require("./js/news-service");
...
// coздаю новый класс//
const apiService = new (0, _newsServiceDefault.default)();
apiService.filmRequest();
inputEl.addEventListener("input", (0, _lodashDebounceDefault.default)(filmName, 1000));
...
function filmName(e) {
    ...
    apiService.filmRequest().then((data)=>{
        if (data.length === 0) return alert("\u043F\u0440\u043E\u0432\u0435\u0440\u0442\u0435 \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E\u0441\u0442\u044C \u0432\u0432\u043E\u0434\u0430");
    // addListTemplates(data);
    });
} // добавляем разметку галлереи по шаблону//
 // function addListTemplates(results) {
 //   console.log(results, galeryEl);
 //   // galeryEl.insertAdjacentHTML('beforeend', templates(films));
 // }

},{"lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/news-service":"1qRqG"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"1qRqG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired76b")
